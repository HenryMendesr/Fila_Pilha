...
Este projeto implementa duas estruturas de dados básicas em Java (Fila e Pilha) usando listas encadeadas. <br>
O objetivo é demonstrar o funcionamento prático das operações de inserção, remoção e exibição em estruturas dinâmicas. <br>
O código foi feito sem o uso de bibliotecas ou estruturas prontas, seguindo as restrições da disciplina. <br>
...
- **Main.java** – Classe que cria e testa as duas estruturas.
